...
const calculateGreenScore = () => {
  ...
  return (
    ...
    <div className='steps'>
        ...
        <input className='box' name="networkMarginalEmissions" onChange={handleInputChange} placeholder={`Network Marginal Emissions: ${formatNumber(networkMarginalEmissions)}`} />
